...
import numpy as np
import numpy.ma
from astropy.coordinates import (ICRS, HeliocentricTrueEcliptic, Longitude,
                                 SkyCoord)
...
def init_sky(projection='mollweide', ra_center=120,
  ...
  # Set axis labels.
  #
  ax.set_xlabel('RA [$\degree$]', labelpad=16, fontsize=15)
  # ax.xaxis.label.set_fontsize(12)
  ax.set_ylabel('Dec [$\degree$]', labelpad=15, fontsize=15)
